...
Run:    python3 docs/pitch/brief/export.py   (from anywhere)
"""
import pathlib
...
SLIDES = HERE / "slides"
COUNT = 13  # keep in step with the <section class="slide"> count in index.html
...
pdf = HERE / "comfyui-on-openshift-brief.pdf"
